...
inline bool ABC_Nested::value() const {
  tracker_.bitmap_[0].fetch_or(1U << 0);
  tracker_.state_.fetch_or(4);
...
inline int ABC::a_size() const {
  tracker_.bitmap_[0].fetch_or(1U << 0);
  tracker_.state_.fetch_or(4);
  // @@protoc_insertion_point(field_size:test.ABC.a)
...
inline int ABC::a_index_size() const {
  tracker_.bitmap_[0].fetch_or(1U << 1);
  tracker_.state_.fetch_or(4);
  // @@protoc_insertion_point(field_size:test.ABC.a_index)
...
inline int ABC::a_notused_size() const {
  tracker_.bitmap_[0].fetch_or(1U << 2);
  tracker_.state_.fetch_or(4);
  // @@protoc_insertion_point(field_size:test.ABC.a_notused)
...
inline const std::string& ABC::b() const {
  tracker_.bitmap_[0].fetch_or(1U << 3);
  tracker_.state_.fetch_or(4);
...
inline const std::string& ABC::b_notused() const {
  tracker_.bitmap_[0].fetch_or(1U << 4);
  tracker_.state_.fetch_or(4);
...
inline const std::string& ABC::c() const {
  tracker_.bitmap_[0].fetch_or(1U << 5);
  tracker_.state_.fetch_or(4);
...
inline const std::string& ABC::c_notused() const {
  tracker_.bitmap_[0].fetch_or(1U << 6);
  tracker_.state_.fetch_or(4);
...
inline bool ABC::has_d() const {
  tracker_.bitmap_[0].fetch_or(1U << 7);
  tracker_.state_.fetch_or(4);
...
inline bool ABC::has_d_notused() const {
  tracker_.bitmap_[0].fetch_or(1U << 8);
  tracker_.state_.fetch_or(4);
